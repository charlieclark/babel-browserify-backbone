...
},{"babelify/polyfill":183,"detection":186,"misc/layout":187,"pages":188,"state":190,"utils":196,"views/AppView":199}],186:[function(require,module,exports){
"use strict";
...
},{"pipe":189,"state":190,"utils":196}],188:[function(require,module,exports){
"use strict";
...
},{"views/pages/HomePageView":202,"views/pages/SecondaryPageView":203,"views/pages/SinglePageView":204}],189:[function(require,module,exports){
'use strict';
...
var pipe = _.extend({
	...
	dispatch: function dispatch() {
		...
		if (this.log) {
			this.message('cmd: ' + args[0] + ' args: ' + args.slice(1, args.length));
		}

		pipe.trigger.apply(this, arguments);
	},
	message: function message() {
		...
		(_console$log = console.log).call.apply(_console$log, [console, 'pipe --'].concat(args));
	}
}, Backbone.Events);

module.exports = window.pipe = pipe;
...
var state = new (Backbone.Model.extend({
	...
	navigate: function navigate(page, section, path, reset) {
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='secondary page\n\n<button data-cmd="navigate:page" data-arg="secondary,something">single</button>';
}
return __p;
};
...
},{"json-vars.json":205,"utils/getEnv":197,"utils/partials":198}],197:[function(require,module,exports){
"use strict";
...
},{"pages":188,"state":190,"templates/appTemplate.html":191,"views/HeaderView":201}],200:[function(require,module,exports){
"use strict";
...
},{"state":190,"templates/headerTemplate.html":192}],202:[function(require,module,exports){
"use strict";
...
},{"pipe":189,"templates/pages/homePageTemplate.html":193,"views/BasePageView":200}],203:[function(require,module,exports){
"use strict";
...
},{"pipe":189,"templates/pages/secondaryPageTemplate.html":194,"views/BasePageView":200}],204:[function(require,module,exports){
"use strict";
...
},{"pipe":189,"templates/pages/singlePageTemplate.html":195,"views/BasePageView":200}],205:[function(require,module,exports){
module.exports={
	"breakpoints": {
		"medium": "1200px",
		"medium-small": "1000px",
