...
var _miscLayout = require("misc/layout");

var _miscLayout2 = _interopRequireDefault(_miscLayout);
...
window.utils = utils;
window.detection = detection;var MyApp = window.App = Marionette.Application.extend({
	el: "body",
	regions: {
		mainRegion: "#content"
	},
	initialize: function initialize() {
		_miscLayout2["default"].init();
	},
	onStart: function onStart() {
		var appView = new _viewsAppView2["default"]({
		...
		_state2["default"].start(_pages2["default"]);
		_state2["default"].set({
			env: utils.getEnv()
		});
...
},{"babelify/polyfill":183,"detection":186,"misc/layout":187,"pages":188,"state":189,"utils":195,"views/AppView":198}],186:[function(require,module,exports){
"use strict";
...
var breakpoints = (0, _utils.getSassVar)("breakpoints");
var width = window.innerWidth;

var touch = !!('ontouchstart' in window);
exports.touch = touch;
var mobile = touch && width <= breakpoints['small'];
...
},{"utils":195}],187:[function(require,module,exports){
"use strict";
...
function init() {
	...
	breakpoints = (0, _utils.getSassVar)("breakpoints");
...
function listenForState() {
	//state change
	_state2["default"].on("change", function (model) {
		onStateChange(model.changed, model.defaults, model._previousAttributes);
	}, this);

	onStateChange(_state2["default"].toJSON(), _state2["default"].defaults);
}
...
},{"state":189,"utils":195}],188:[function(require,module,exports){
"use strict";
...
var _viewsPagesHomePageView = require("views/pages/HomePageView");

var _viewsPagesHomePageView2 = _interopRequireDefault(_viewsPagesHomePageView);

var _viewsPagesSecondaryPageView = require("views/pages/SecondaryPageView");

var _viewsPagesSecondaryPageView2 = _interopRequireDefault(_viewsPagesSecondaryPageView);

var _viewsPagesSinglePageView = require("views/pages/SinglePageView");

var _viewsPagesSinglePageView2 = _interopRequireDefault(_viewsPagesSinglePageView);

exports["default"] = {
	"home": {
		view: _viewsPagesHomePageView2["default"],
	...
	"secondary": {
		view: _viewsPagesSecondaryPageView2["default"],
		model: Backbone.Model,
	...
	"secondary-single": {
		view: _viewsPagesSinglePageView2["default"],
		model: Backbone.Model,
		options: {
			tag: "",
			type: ""
...
},{"views/pages/HomePageView":201,"views/pages/SecondaryPageView":202,"views/pages/SinglePageView":203}],189:[function(require,module,exports){
"use strict";
...
var state = new (Backbone.Model.extend({
	...
	onRoute: function onRoute(page, section, path) {
	...
	navigate: function navigate(page, section, path, reset, noTrigger) {
	...
	getPath: function getPath(page, section, path, reset) {
	...
	getUrlPageName: function getUrlPageName(name, reverse) {
		var returnName = _.findKey(this.urlNames, function (value) {
			return name == value;
		});
	...
	unSingle: function unSingle(str) {
		if (str) {
			str = str.replace("-single", "");
		}
		return str;
	},
	start: function start(pages) {
		var _this = this;
		...
		_.each(pages, function (page, key) {
			key = _this.unSingle(key);
			if (!_this.urlNames[key]) {
				_this.urlNames[key] = page.slug || key;
			}
			if (page["default"]) {
				_this.defaultPage = key;
			}
		});
...
__p+='\n\t\t';
 if(page.inNav){ 
__p+='\n\t\t\t<li data-cmd="change:page" data-channel="navigation" data-arg="'+
((__t=(key))==null?'':__t)+
'"><span>'+
((__t=( page.slug || key ))==null?'':__t)+
'</span></li>\n\t\t';
 } 
__p+='\n\t';
 }) 
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='secondary page\n\n<button data-cmd="change:page" data-channel="navigation" data-arg="secondary,something">single</button>\n\n';
}
return __p;
};
...
exports.getSassVar = getSassVar;
exports.loadBgImagesInEl = loadBgImagesInEl;
...
var _jsonVarsJson = require("json-vars.json");

var _jsonVarsJson2 = _interopRequireDefault(_jsonVarsJson);

//modular utils

var _utilsGetEnv = require("utils/getEnv");

_defaults(exports, _interopExportWildcard(_utilsGetEnv, _defaults));

var _utilsPartials = require("utils/partials");

_defaults(exports, _interopExportWildcard(_utilsPartials, _defaults));

function getSassVar(key) {
	var value = _jsonVarsJson2["default"][key];
...
function loadBgImagesInEl($el) {
	var preloadClass = "preloaded";
	var preloadingClass = "preloading";
	var elsToLoad = $el.find(".data-bg:not(." + preloadingClass + "):not(." + preloadClass + ")");
	elsToLoad.each(function () {
		var $item = $(this);
		var src = $item.data("bg");
		var $inner = $("<div class='data-bg-inner'>");
		$item.append($inner);
...
},{"json-vars.json":204,"utils/getEnv":196,"utils/partials":197}],196:[function(require,module,exports){
"use strict";
...
window.partial = function (key, _data) {
	...
	var data = _.extend({}, baseDefaults, templates[key].defaults || {}, _data || {});
...
var AppView = Marionette.LayoutView.extend({
	...
	initialize: function initialize() {
		Marionette.bindEntityEvents(this, _state2["default"], this.stateEvents);

		Backbone.Radio.channel("navigation").on("change:page", function () {
			...
			var path = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];

			_state2["default"].navigate(page, section, path, true);
		});
	...
	onBeforeShow: function onBeforeShow() {
		$(window).scrollTop(0);
		this.showChildView("header", new _viewsHeaderView2["default"]({
			model: this.model
		}));
		this.createPageRegions();
	},
	createPageRegions: function createPageRegions() {
		_.each(_pages2["default"], function (value, key) {
			var id = "page-" + key;
			this.ui.pageContainer.append($("<section class=\"page\" id=\"" + id + "\"></section>"));
			this.addRegion(key, "#" + id);
		}, this);
	},
	onRouteChange: function onRouteChange(model) {
		var _this = this;

		var routePage = model.get("page");
		var routeSection = model.get("section");

		console.log(routePage, routeSection);

		var pageKey = null;

		if (routeSection && _pages2["default"][routePage + "-single"]) {
			pageKey = routePage + "-single";
		} else if (_pages2["default"][routePage]) {
			pageKey = routePage;
		}
		...
		var newRouteValues = _.pick(model.toJSON(), "page", "section", "path");
		...
		var newPageView = this.createNextPage(pageKey);

		Promise.all([this.hideCurrentPage(), newPageView.beforeCanShow()]).then(function () {
			_this.showPage(pageKey, newPageView);
		});

		this._currentRouteValues = newRouteValues;
		this._currentPageKey = pageKey;
	},
	hideCurrentPage: function hideCurrentPage() {
		var _this2 = this;

		return new Promise(function (resolve, reject) {
			var region = _this2.getRegion(_this2._currentPageKey);
	...
	showPage: function showPage(pageKey, newPageView) {
		var region = this.getRegion(pageKey);
	...
	createNextPage: function createNextPage(pageKey) {
		var NewView = _pages2["default"][pageKey].view;
		var NewModel = _pages2["default"][pageKey].model;
		var options = _pages2["default"][pageKey].options || {};
	...
	commandButtonClick: function commandButtonClick(e) {
		var _Backbone$Radio$channel;

		var $el = $(e.currentTarget);

		var cmd = $el.data("cmd");
		var channel = $el.data("channel") || "global";
		var arg = $el.data("arg") || "";
		arg = arg.split(",");

		(_Backbone$Radio$channel = Backbone.Radio.channel(channel)).trigger.apply(_Backbone$Radio$channel, [cmd].concat(_toConsumableArray(arg)));
	}
});

module.exports = AppView;

},{"pages":188,"state":189,"templates/appTemplate.html":190,"views/HeaderView":200}],199:[function(require,module,exports){
"use strict";
...
var BasePageView = Marionette.LayoutView.extend({
	...
	beforeCanShow: function beforeCanShow() {
...
var HeaderView = Marionette.LayoutView.extend({
	...
	initialize: function initialize() {
		this.listenTo(_state2["default"], "change:page", this.onPageChange);
	},
	onPageChange: function onPageChange() {
		this.ui.navItems.removeClass("active");
		this.ui.navItems.filter(function () {
			return $(this).data("arg") == _state2["default"].get("page");
		}).addClass("active");
	}
});
...
},{"state":189,"templates/headerTemplate.html":191}],201:[function(require,module,exports){
"use strict";
...
var _viewsBasePageView = require("views/BasePageView");

var _viewsBasePageView2 = _interopRequireDefault(_viewsBasePageView);

var HomePageView = _viewsBasePageView2["default"].extend({
...
},{"templates/pages/homePageTemplate.html":192,"views/BasePageView":199}],202:[function(require,module,exports){
"use strict";
...
var SecondaryPageView = _viewsBasePageView2["default"].extend({
	template: require("templates/pages/secondaryPageTemplate.html")
});

exports["default"] = SecondaryPageView;
module.exports = exports["default"];

},{"templates/pages/secondaryPageTemplate.html":193,"views/BasePageView":199}],203:[function(require,module,exports){
"use strict";
...
var SinglePageView = _viewsBasePageView2["default"].extend({
	template: require("templates/pages/singlePageTemplate.html")
});

exports["default"] = SinglePageView;
module.exports = exports["default"];

},{"templates/pages/singlePageTemplate.html":194,"views/BasePageView":199}],204:[function(require,module,exports){
module.exports={
	"breakpoints": {
		"medium": "1200px",
		"medium-small": "1000px",
